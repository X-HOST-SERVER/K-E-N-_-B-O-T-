...
.\n` +
   '╭────────────────────────────╮\n' +
  '│ 🔐 How would you like to log in, Don? │\n' +
  '╰────────────────────────────╯\n' +
  '\n' +
  '🧬 *qr* books to scan the QR code.\n' +
  '📮 Or type *code* to enter an 8-digit code.\n' +
  '\n' +
  '> '
  )
);
  ...
  if (loginMethod === 'code') {
    let phoneNumber = await question(chalk.blue('اكتب رقمك الان مثال: 201122805226:\n'));
